...
def main():
    ...
    try:
        ...
        birthday_output = birthday.strftime("%Y-%m-%d") #Formatting Birthday
        print(birthday_output) 

        delta = today - birthday
        print(f'Difference is {delta.days} days')
        delta_years = delta.days // 365.2425 #Calculates Days old
        delta_months = delta_years * 12 #Calculates the Years old
        delta_weeks = delta_months * 4.34524 #Calculates Months old
       #Print Statements for Each Calculation
